...
- **US-9.3** Déclarer sa faction pour un tournoi, sans liste d'armée — **M** — dép. US-9.2 (livrée), US-2.3 (livrée). — 📋 **Rédigée (2026-08-27)**, prête à développer
...
- **US-9.4** L'organisateur renseigne ou corrige la faction d'un joueur au pointage — **S** — dép. US-9.3. — 📋 **À faire**
